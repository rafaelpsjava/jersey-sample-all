...
import br.com.company.projectname.util.lookup.ServiceLocator;
 ...
 */
@Provider
public class EjbContextInjectionResolver implements InjectionResolver<Ejb> {

	@Override
	public Object resolve(Injectee injectee, ServiceHandle<?> root) {
		final AnnotatedElement annotedElement = injectee.getParent();
		if (annotedElement != null) {
			Ejb ejbAnnotation = annotedElement.getAnnotation(Ejb.class);
			String ejbName = null;
